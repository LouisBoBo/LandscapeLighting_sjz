...
public class AutoHideView extends FrameLayout {
    ...
    private void initView() {
        ...
        ImageView switch_close = findViewById(R.id.switch_close);
...
//                    switchScreenImage.setImageResource(R.drawable.ic_maximum_white_nor_24);
        ...
        switch_close.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                monitorCloseBtnClickClickListener.click();
            }
        });

    }

    OnMonitorCloseBtnClickClickListener monitorCloseBtnClickClickListener;
    public interface OnMonitorCloseBtnClickClickListener {
        void click();
    }
    public void setOnMonitorCloseBtnClickClickListener(OnMonitorCloseBtnClickClickListener onMonitorCloseBtnClickClickListener) {
        this.monitorCloseBtnClickClickListener = onMonitorCloseBtnClickClickListener;
    }
