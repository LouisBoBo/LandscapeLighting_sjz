...
import com.peng.pswitch.DimensionUtil;


public class MyPSwitchView extends View {
    ...
    public MyPSwitchView(Context context) {
        this(context, null);
    }

    public MyPSwitchView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyPSwitchView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs, defStyleAttr);
    }

    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, com.peng.pswitch.R.styleable.PSwitchView);
        mOnColor = a.getColor(com.peng.pswitch.R.styleable.PSwitchView_switch_open_color, ContextCompat.getColor(context, com.peng.pswitch.R.color.switch_open_color));
        mOffColor = a.getColor(com.peng.pswitch.R.styleable.PSwitchView_switch_close_color, ContextCompat.getColor(context, com.peng.pswitch.R.color.switch_close_color));
        mDotColor = a.getColor(com.peng.pswitch.R.styleable.PSwitchView_switch_dot_color, ContextCompat.getColor(context, com.peng.pswitch.R.color.switch_dot_color));
        mSlidable = a.getBoolean(com.peng.pswitch.R.styleable.PSwitchView_switch_slidable, true);
        mDotMargin = a.getDimensionPixelSize(com.peng.pswitch.R.styleable.PSwitchView_switch_dot_margin, DimensionUtil.dip2px(getContext(), 1.5f));
        mChecked = a.getBoolean(com.peng.pswitch.R.styleable.PSwitchView_switch_checked, false);
        int shapeValue = a.getInt(com.peng.pswitch.R.styleable.PSwitchView_switch_shape, 0);
    ...
    public void setInitChecked(boolean checked) {
        if (!isOnAttach) {
            mLastStatus = isChecked();
            mChecked = checked;
            initDraw();
