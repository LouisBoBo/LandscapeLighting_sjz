 ...
 */
public final class MyWidgetUtils {

    private MyWidgetUtils() {
     ...
     */
    public static MyMiniLoadingDialog getMiniLoadingDialog(@NonNull Context context) {
        return new MyMiniLoadingDialog(context);
    }
     ...
     * @return MiniLoadingDialog加载框
     */
    public static MyMiniLoadingDialog getMiniLoadingDialog(@NonNull Context context, @NonNull String message) {
        return new MyMiniLoadingDialog(context, message);
    }
