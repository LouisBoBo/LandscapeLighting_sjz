 ...
 */
public class MyMiniLoadingView extends View {
    ...
    public MyMiniLoadingView(Context context) {
        this(context, null);
    }

    public MyMiniLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.MiniLoadingStyle);
    }

    public MyMiniLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(context, attrs, defStyleAttr);
        initPaint();
    }

    public MyMiniLoadingView(Context context, int size, int color) {
        super(context);
        mSize = size;
        mPaintColor = color;
        initPaint();
